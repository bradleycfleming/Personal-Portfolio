    ...
    <div className="bg-base-200 antialiased">
      <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-16 lg:py-0">
        <div className="lg:flex lg:justify-between lg:gap-4">
          <div className="flex flex-col lg:w-[48%] lg:py-24 lg:top-1 lg:flex lg:max-h-screen lg:sticky">
          ...
          <main className="pt-24 lg:w-[52%] lg:py-24">
            <section id="about" className="flex flex-col flex-start mb-16 md:mb-20 lg:mb-28">
              ...
              <p className="text-base-content ">
                ...
                developers to bring projects to life. I’m always learning and
                staying updated on the latest web development trends and
                technologies. Let’s connect if you need someone to help create a
                seamless and engaging digital experience!
              </p>
            </section>
            <section id="experience" className="flex flex-col flex-start mb-16 md:mb-20 lg:mb-28">
            ...
            <section id="skills" className="flex flex-col flex-start mb-16 md:mb-20 lg:mb-28">
              <h1 className="text-medium font-bold uppercase tracking-widest text-base-content mb-3">
                Skills
              </h1>
            </section>
            <section id="projects" className="flex flex-col flex-start mb-16 md:mb-20 lg:mb-28">
              <h1 className="text-medium font-bold uppercase tracking-widest text-base-content mb-3">
                Projects
              </h1>
            </section>
